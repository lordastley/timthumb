...
if(! defined('DEFAULT_Q') )                     define ('DEFAULT_Q', 90);                               // Default image quality. Allows override in timthumb-config.php
if(! defined('DEFAULT_ZC') )                    define ('DEFAULT_ZC', 1);                               // Default zoom/crop setting. Allows override in timthumb-config.php
if(! defined('DEFAULT_F') )                     define ('DEFAULT_F', '');                               // Default image filters. Allows override in timthumb-config.php
if(! defined('DEFAULT_S') )                     define ('DEFAULT_S', 0);                                // Default sharpen value. Allows override in timthumb-config.php
if(! defined('DEFAULT_CC') )                    define ('DEFAULT_CC', 'ffffff');                        // Default canvas colour. Allows override in timthumb-config.php
if(! defined('DEFAULT_U') )                     define ('DEFAULT_U', 0);                                // Default upscale flag. Allows override in timthumb-config.php
if(! defined('DEFAULT_D') )                     define ('DEFAULT_D', 0);                                // Default dither algorithm. Allows override in timthumb-config.php
if(! defined('DEFAULT_AR') )                    define ('DEFAULT_AR', 1);                               // Default maintain aspect ratio flag. Allows override in timthumb-config.php
if(! defined('DEFAULT_WIDTH') )                 define ('DEFAULT_WIDTH', 100);                          // Default thumbnail width. Allows override in timthumb-config.php
if(! defined('DEFAULT_HEIGHT') )                define ('DEFAULT_HEIGHT', 100);                         // Default thumbnail height. Allows override in timthumb-config.php
...
class timthumb {
        ...
        protected function processImageAndWriteToCache($localImage){
                ...
                // MY HAX
                $dither = $this->param('d', DEFAULT_D); //1-bit dither!
                $upscale = (bool) $this->param('u', DEFAULT_U); 
                $maintain_aspect = (bool) $this->param('ar', DEFAULT_AR); 
